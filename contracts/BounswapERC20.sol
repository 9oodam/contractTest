...
contract Token is ERC20 {
    ...
    constructor(string memory _name, string memory _symbol, uint256 _amount, string _uri) {
        owner = msg.sender;
        name = _name;
        symbol = _symbol;
        uri = tokenURI(_uri);
    ...
    function tokenURI(string memory _imageUri) public view override returns (string memory) {
